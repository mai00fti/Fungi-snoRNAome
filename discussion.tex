...
four. Additionally, for 26 of 39 orphan \sno s (or predictions based
on single-sequence predictions only) could be mapped to experimentally
verified targets or a reliable prediction based on conserved ASEs
could be assigned.}
