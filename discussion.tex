...
individual snoRNA sequences. \NEW{For 18 snoRNA families previously
...
with single-sequence target predictions only) a mapping to
experimentally verified targets could be found, or a least a quite
convincing prediction based on the Interaction Conservation Index
