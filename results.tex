...
\NEW{Ribo-seq or ribosome profiling combines ribosome footprinting with
  ...
  \PFS{Importantly, all \sno{}s in \sce\ were based on independent
    experimental studies, the serve as a positive control for the use of
  ...
  \cite{Ingolia:2009}, with evidence from every datasets supporting 52
  \sno{}s, and 65 \sno{}s are classified as 'non-coding' based on their
  ...
  respectively. In \aca are all \sno\ genes classified as 'non-coding', in
  \calb\ two sequences lack support from the PME scoring. Almost all of the
  \sno{}s without support by the PME-score lack sufficient read coverage
  for the \texttt{Rfoot} analysis. The available Ribo-seq data thus
  strongly supports the \snostrip -annotated \sno{}ome.
}
