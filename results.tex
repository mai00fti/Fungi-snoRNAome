...
To add further reliability to our \sno\ annotations, we compared
our data with \rfam -annotated families and additionally cross-checked with Ribo-seq
archives of four differnt Fungi. This should allow us to point out
that our \snostrip\ annotations are inline with existing \rfam\
...
source of well-curated data on non-coding RNAs. The
  7852 \snostrip -detected \sno s encompass the overwhelming majority of
  \rfam -annotated sequences (1586 of 1621 \sno\ genes), and 441 of them
are located in seed alignments.  Most of the 35 \rfam\ \sno\ sequences
that are not included in our data set exhibit box motifs with two or more mutations
compared to the consensus sequence. This prevents \snostrip\ from
...
experimentally verified \sno s that served as the starting point for
...
different \rfam\ models to a common \sno\ family. A detailed
...
sequences of the \rfam\ models RF01209 and RF01514, which were derived
  from Saccharomycetales and Pezizomycotina species, respectively. A
...
\NEW{Ribo-seq or ribosome profiling combines ribosome footprinting
  ...
  RNAs, and snoRNAs \cite{Ingolia:2014, Ji:2016}. 
  ...
  PME-scores calculated by the \texttt{Rfoot} tool \cite{Ji:2016}. The complete results can be seen in section S11 in the
  ...
  analysis.
Even though, the available Ribo-seq data strongly supports
