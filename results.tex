...
A set of 68 \cd\ and 50 \haca\ families were searched for additional
...
associations. This resulted in a total amount of 5595 and 2331 \cd\
and \haca\ sequences. Hence, we expanded the fungi snoRNA complement
by \SB{XXX$\%$} and immensely increased its resolution.
...
\paragraph{\textbf{Sequence}} \JH{Can we include a figure,
  e.g. boxplot for all boxes of \cd s and \haca s here? I don't like
  these numbers in the text.} In accordance with the published \cd\
...
\JH{Please rephrase the next paragraph} In general, fungal \sno\
