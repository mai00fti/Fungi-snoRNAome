...
\SB{In this work, the naming pattern of snoRNAs mostly follows the convention established by the surveys where these query snoRNAs originated from. Normally, the predominant order of naming is: \emph{S.cerevisiae}, \emph{N.crassa}, \emph{A.fumigatus},
