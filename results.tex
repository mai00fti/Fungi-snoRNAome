\NEW{Up to now, there is no generally accepted nomenclature of snoRNA
  families across different fungal species and quite a few \sno\ genes
...
\NEW{Due to our comprehensive \sno\ dataset, it is now feasible to
  thoroughly examine the phylogenetic fundmanent of fungal \sno s.}  A
...
\NEW{In the following, we will present an in-depth description of 
  highly complex rearrangements including target translocations and
...
experimentally verified \PFS{\sno s that served as the starting point for
...
different \rfam\ models to a common \sno\ family. \PFS{A detailed
  ...
  disjoint sets of organisms and indeed share the same target guiding
...
\NEW{Ribo-seq or ribosome profiling combines ribosome footprinting
  ...
  one of the three short read archives, with 46 \sno s supported in
  ...
  datasets, respectively. In \aca, all \sno\ genes are classified as
