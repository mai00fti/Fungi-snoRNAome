...
\begin{abstract}
  ...
  individual \sno\ sequences \PFS{doubles the number of attested fungal
    \sno\ families and increases the number of sequences by 450\%. We show}
  that the {\sno} landscape is subject to ongoing re-arrangements and
  adaptations, e.g., through lineage-specific targets and redundant guiding
  functions.
