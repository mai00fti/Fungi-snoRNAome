...
\NEW{Up to date, the topic of fungal \sno s has mainly been approached
  ...
  \sno\ landscape.  This leaves plenty of uncharted areas to be
...
\NEW{\paragraph{Ribosome footprinting} Despite its natural purpose of
  ...
  \cite{Ingolia:2014, Ji:2016}. We therefore
    ...
    hence serve here as a positive control for the use of Ribo-seq data.

    In addition to the raw read data, we also evaluated the localization of these
  ...
  regions, employing the \texttt{Rfoot} tool \cite{Ji:2016}. 
}
